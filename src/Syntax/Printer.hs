...
instance Print (Stmt a) where
  prt i e = case e of
    ...
    For _ type_ id expr -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 type_, prt 0 id, doc (showString ":"), prt 0 expr, doc (showString ")")])
...
instance Print (Expr a) where
  prt i e = case e of
    ...
    ELitNull _ type_ -> prPrec i 6 (concatD [doc (showString "("), prt 0 type_, doc (showString ")null")])

...
newtype ArgIdent = ArgIdent String deriving (Eq, Ord, Show, Read)
...
data Instr a
    = ILabel a LabIdent
    | ILabelAnn a LabIdent Integer Integer Integer Integer
    | IVRet a
    | IRet a (Val a)
...
instance Functor Instr where
    fmap f x = case x of
        ...
        ILabelAnn a labident integer1 integer2 integer3 integer4 -> ILabelAnn (f a) labident integer1 integer2 integer3 integer4
        IVRet a -> IVRet (f a)
...
instance Functor Val where
    fmap f x = case x of
        ...
        VArg a argident -> VArg (f a) argident
data Op a
    = OpAdd a
    | OpSub a
    | OpMul a
